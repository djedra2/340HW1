...
\begin{DoxyCompactList}\small\item\em Used to create new window. \end{DoxyCompactList}\item 
\hyperlink{class_main_window_ae98d00a93bc118200eeef9f9bba1dba7}{$\sim$\-Main\-Window} ()
\begin{DoxyCompactList}\small\item\em Deletes the Main window. \end{DoxyCompactList}\end{DoxyCompactItemize}
